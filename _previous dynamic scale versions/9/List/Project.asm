...
; 0000 0166     scale_sum += scale_array[3];
	...
	CALL __ADDF12
	STS  _scale_sum,R30
	STS  _scale_sum+1,R31
	STS  _scale_sum+2,R22
	STS  _scale_sum+3,R23
...
; 0000 0168     scale1_sum += scale1_array[3];
	...
	CALL __ADDF12
	STS  _scale1_sum,R30
	STS  _scale1_sum+1,R31
	STS  _scale1_sum+2,R22
	STS  _scale1_sum+3,R23
...
; 0000 016A     scale2_sum += scale2_array[3];
	...
	CALL __ADDF12
	STS  _scale2_sum,R30
	STS  _scale2_sum+1,R31
	STS  _scale2_sum+2,R22
	STS  _scale2_sum+3,R23
; 0000 016B     }
	__ADDWRN 18,19,1
	RJMP _0x4E
_0x4F:
...
SUBOPT_0x23:
	LDS  R26,_scale_sum
	LDS  R27,_scale_sum+1
	LDS  R24,_scale_sum+2
	LDS  R25,_scale_sum+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:3 WORDS
SUBOPT_0x24:
	LDS  R26,_scale1_sum
	LDS  R27,_scale1_sum+1
	LDS  R24,_scale1_sum+2
	LDS  R25,_scale1_sum+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:3 WORDS
SUBOPT_0x25:
	LDS  R26,_scale2_sum
	LDS  R27,_scale2_sum+1
	LDS  R24,_scale2_sum+2
	LDS  R25,_scale2_sum+3
	RET
