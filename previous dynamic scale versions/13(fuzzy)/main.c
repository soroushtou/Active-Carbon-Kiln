...
float         scale_test1 = 64,scale_test2 = 800,scale_test3 = 0;
...
FLAGS returnvalue;            /* declare return value for fuzzy control*/
...
while (1)
      { 
        ...
        Variable_fuzzy_co = scale_test1;
        Weight_fuzzy_co = scale_test2;
        returnvalue = fuzzy_co();      /* call the fuzzy system */
        scale_test3 = MotorVoltage_fuzzy_co;
