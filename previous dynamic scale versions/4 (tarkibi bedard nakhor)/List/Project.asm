...
; 0000 012B     if(HX711_Buffer > Weight_Maopi)
	LDS  R30,_Weight_Maopi
	LDS  R31,_Weight_Maopi+1
	LDS  R22,_Weight_Maopi+2
	LDS  R23,_Weight_Maopi+3
	CALL SUBOPT_0x12
	CALL __CPD12
	BRSH _0x48
; 0000 012C     {
...
; 0000 013A     if(HX711_Buffer1 > Weight_Maopi1)
	LDS  R30,_Weight_Maopi1
	LDS  R31,_Weight_Maopi1+1
	LDS  R22,_Weight_Maopi1+2
	LDS  R23,_Weight_Maopi1+3
	CALL SUBOPT_0x1D
	CALL __CPD12
	BRSH _0x4A
; 0000 013B     {
...
; 0000 0149     if(HX711_Buffer2 > Weight_Maopi2)
	LDS  R30,_Weight_Maopi2
	LDS  R31,_Weight_Maopi2+1
	LDS  R22,_Weight_Maopi2+2
	LDS  R23,_Weight_Maopi2+3
	CALL SUBOPT_0x22
	CALL __CPD12
	BRSH _0x4C
; 0000 014A     {
...
; 0000 015C     scale = (float)HX711_Buffer_sum / 4 ;
	LDS  R30,_HX711_Buffer_sum
	LDS  R31,_HX711_Buffer_sum+1
	LDS  R22,_HX711_Buffer_sum+2
	LDS  R23,_HX711_Buffer_sum+3
	CALL SUBOPT_0x30
	STS  _scale,R30
	STS  _scale+1,R31
	STS  _scale+2,R22
...
; 0000 015D     scale1 = (float)HX711_Buffer1_sum / 4 ;
	LDS  R30,_HX711_Buffer1_sum
	LDS  R31,_HX711_Buffer1_sum+1
	LDS  R22,_HX711_Buffer1_sum+2
	LDS  R23,_HX711_Buffer1_sum+3
	CALL SUBOPT_0x30
	STS  _scale1,R30
	STS  _scale1+1,R31
	STS  _scale1+2,R22
...
; 0000 015E     scale2 = (float)HX711_Buffer2_sum / 4 ;
	LDS  R30,_HX711_Buffer2_sum
	LDS  R31,_HX711_Buffer2_sum+1
	LDS  R22,_HX711_Buffer2_sum+2
	LDS  R23,_HX711_Buffer2_sum+3
	CALL SUBOPT_0x30
	STS  _scale2,R30
	STS  _scale2+1,R31
	STS  _scale2+2,R22
...
SUBOPT_0x11:
	LDI  R30,LOW(0)
	STS  _HX711_Buffer_sum,R30
	STS  _HX711_Buffer_sum+1,R30
	STS  _HX711_Buffer_sum+2,R30
	STS  _HX711_Buffer_sum+3,R30
	STS  _HX711_Buffer1_sum,R30
	STS  _HX711_Buffer1_sum+1,R30
	STS  _HX711_Buffer1_sum+2,R30
	STS  _HX711_Buffer1_sum+3,R30
	STS  _HX711_Buffer2_sum,R30
	STS  _HX711_Buffer2_sum+1,R30
	STS  _HX711_Buffer2_sum+2,R30
	STS  _HX711_Buffer2_sum+3,R30
	RET
...
SUBOPT_0x29:
	LDS  R26,_HX711_Buffer_sum
	LDS  R27,_HX711_Buffer_sum+1
	LDS  R24,_HX711_Buffer_sum+2
	LDS  R25,_HX711_Buffer_sum+3
	RET
...
SUBOPT_0x2B:
	STS  _HX711_Buffer_sum,R30
	STS  _HX711_Buffer_sum+1,R31
	STS  _HX711_Buffer_sum+2,R22
	STS  _HX711_Buffer_sum+3,R23
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 4 TIMES, CODE SIZE REDUCTION:15 WORDS
SUBOPT_0x2C:
	LDS  R26,_HX711_Buffer1_sum
	LDS  R27,_HX711_Buffer1_sum+1
	LDS  R24,_HX711_Buffer1_sum+2
	LDS  R25,_HX711_Buffer1_sum+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 3 TIMES, CODE SIZE REDUCTION:9 WORDS
SUBOPT_0x2D:
	STS  _HX711_Buffer1_sum,R30
	STS  _HX711_Buffer1_sum+1,R31
	STS  _HX711_Buffer1_sum+2,R22
	STS  _HX711_Buffer1_sum+3,R23
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 4 TIMES, CODE SIZE REDUCTION:15 WORDS
SUBOPT_0x2E:
	LDS  R26,_HX711_Buffer2_sum
	LDS  R27,_HX711_Buffer2_sum+1
	LDS  R24,_HX711_Buffer2_sum+2
	LDS  R25,_HX711_Buffer2_sum+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 3 TIMES, CODE SIZE REDUCTION:9 WORDS
SUBOPT_0x2F:
	STS  _HX711_Buffer2_sum,R30
	STS  _HX711_Buffer2_sum+1,R31
	STS  _HX711_Buffer2_sum+2,R22
	STS  _HX711_Buffer2_sum+3,R23
	RET
