...
float         total_weight=0,scale = 0,scale1 = 0,scale2 = 0,scale_sum = 0,scale1_sum = 0,scale2_sum = 0,scale_array[11],scale1_array[11],scale2_array[11];
...
while (1)
      { 
        ...
        get_scale1();
        get_scale2();
        total_weight = scale + scale1 + scale2;  
        ftoa(total_weight,2,str1);  
        //sprintf(buffer1,"%s",str1); 
        //ftoa(scale1,2,str2);  
        //sprintf(buffer2,"%s",str2);
        //ftoa(scale2,2,str3);  
        //sprintf(buffer_test,"%s,%s,%s",str1,str2,str3); 
        sprintf(buffer1,"%s",str1);
        /*for(i=0;i<12;i++) buffer_test[i]=buffer1[i];
        buffer_test[12]=" " ;
        for(i=0;i<12;i++) buffer_test[i+13]=buffer2[i];
        buffer_test[25]=" " ;
        for(i=0;i<12;i++) buffer_test[i+26]=buffer3[i]; */
        puts(buffer1);
