...
void get_scale(void)
{
    ...
    if(HX711_Buffer >= Weight_Maopi)
    {
        ...
        scale = (float)Weight_Shiwu/10;// / 1000; //geram to kilo geram
    }*/
    int i = 0;
    int j = 0;
    buffer_sum=0;
    ...
    HX711_Buffer = HX711_Read();
    HX711_Buffer = HX711_Buffer/100;
    buffer_median[i]= HX711_Buffer;
    }
    sort_array(buffer1_median,21);
    buffer_sum += buffer_median[10];
    }
    buffer_avg = buffer_sum/5;
    //if(buffer1_avg >= Weight_Maopi1){
        Weight_Shiwu = buffer_avg;
        Weight_Shiwu = Weight_Shiwu - Weight_Maopi;

        Weight_Shiwu = ((float)Weight_Shiwu/HX_REF);

        scale = (float)Weight_Shiwu / 10; //geram to kilo geram
...
void get_scale1(void)
{
    ...
    if(HX711_Buffer1 >= Weight_Maopi1)
    {
        ...
        scale1 = (float)Weight_Shiwu1 / 1000; //geram to kilo geram
    } 
        Weight_Shiwu1 = HX711_Buffer1;
        Weight_Shiwu1 = Weight_Shiwu1 - Weight_Maopi1;
        ...
        scale1 = (float)Weight_Shiwu1 / 1000; //geram to kilo geram
    scale1_median[i]=scale;
    }
    sort_array(scale1_median,101);
    scale1_sum = scale1_sum + scale1_median[50];
    }
    scale1_avg = scale1_sum /10;*/   
    int i = 0;
    int j = 0;
    buffer1_sum=0;
    for(j=0;j<5;j++)
    ...
    HX711_Buffer1 = HX711_Read1();
    HX711_Buffer1 = HX711_Buffer1/100;
    buffer1_median[i]= HX711_Buffer1;
    }
    sort_array(buffer1_median,21);
    buffer1_sum += buffer1_median[10];
    }
    buffer1_avg = buffer1_sum/5;
    //if(buffer1_avg >= Weight_Maopi1){
        Weight_Shiwu1 = buffer1_avg;
        Weight_Shiwu1 = Weight_Shiwu1 - Weight_Maopi1;
...
void get_scale2(void)
{
    ...
    if(HX711_Buffer2 >= Weight_Maopi2)
    {
        ...
        scale2 = (float)Weight_Shiwu2 / 1000; //geram to kilo geram
    }  */
    int i = 0;
    int j = 0;
    buffer2_sum=0;
    ...
    HX711_Buffer2 = HX711_Read2();
    HX711_Buffer2 = HX711_Buffer2/100;
    buffer2_median[i]= HX711_Buffer2;
    }
    sort_array(buffer2_median,21);
    buffer2_sum += buffer2_median[10];
    }
    buffer2_avg = buffer2_sum/5;
    //if(buffer1_avg >= Weight_Maopi1){
        Weight_Shiwu2 = buffer2_avg;
        Weight_Shiwu2 = Weight_Shiwu2 - Weight_Maopi2;
