...
*////another HAAAAAAAAAAAANNNNNNNNNNGGGGGGGGGGG
...
void loop() {
  ...
  if(stepper_position - temperature_diff < 40 && stepper_position - temperature_diff > 40){digitalWrite(Flame_stepper1,LOW);digitalWrite(Flame_stepper2,LOW);}
