...
int temperature,temperature_set,temperature_counter,stepper_position,steam_mode,flame_mode,scale_speed;
bool temperature_condition;
unsigned long long time_prev,time_diff;
//bool V0_set_state = false;
//Values for Angle
float yangle,feeder_RPM_set,kiln_RPM_set,feeder_RPM;
//int yangle2;
...
Serial.println("LABEL,Zaman,MQ2_volt,MQ3_volt,MQ4_volt,MQ7_volt,MQ9_volt,MQ135_volt,MQ214_volt,MQ2_ratio,MQ3_ratio,MQ4_ratio,MQ7_ratio,MQ9_ratio,MQ135_ratio,MQ214_ratio,Temperature,Flame_mode,Feeder_RPM,Scale_weight,Scale_Speed,Angle"); //LABEL, so excel knows the next things will be the names of the columns
